...
mylauncher = awful.widget.launcher({ image = gears.filesystem.get_configuration_dir() .. "arch-icon.png",
    command = "dmenu_run" })
...
awful.spawn.with_shell(" picom --experimental-backends --config ~/.config/awesome/p.conf -b")
